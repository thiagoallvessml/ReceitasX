...
// Identify form block accurately
let formRegex = /<div class="ms-body">[\s\S]*?<div class="ms-foot">/;
let newForm = `
        <div class="ms-body">
            <!-- Tipo -->
            <div>
...
// Entire script block replacement
...
console.log('Done rewriting desperdicios.html (v2)');
