...
async function run() {
    const { data, error } = await sb.from('perfis').select('id, email').in('email', ['lucienemariasoaresmarques84@gmail.com', 'santos.beatriz.lais@gmail.com', 'anacecilianascimento.ueap@gmail.com']);
